    ...
    <div className="min-h-screen flex flex-col bg-dark">
      ...
      <div className="relative min-h-[80vh] w-full overflow-hidden flex flex-col">
        ...
        <header className="absolute top-0 left-0 right-0 p-6 z-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white tracking-tight">HairBear</span>
          </div>
          ...
          >
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 w-fit">
                ...
                <span className="text-xs font-medium text-white uppercase tracking-wider">IA de Última Geração</span>
              </div>
              ...
              <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-md">
                Simule cortes de cabelo e estilos de barba com realismo profissional antes de sentar na cadeira do barbeiro.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              ...
              <Button
                variant="secondary" // Usando secondary que tem borda
                size="lg"
                fullWidth
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4 border-t border-white/10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-400">100% Privado</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-400">+10k simulações hoje</span>
              </div>
            </div>
          </motion.div>
        </main>
        ...
        <div className="max-w-5xl mx-auto relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <p className="text-base md:text-lg text-slate-400">
              Faça nosso teste de estilo personalizado. Analisamos seu formato de rosto e preferências para sugerir o visual perfeito para você.
            </p>
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-400">
              Inspire-se com os cortes mais populares da nossa comunidade.
            </p>
          </div>
      ...
      <footer className="py-8 text-center border-t border-white/5 bg-dark">
        <p className="text-slate-500 text-sm">
          © 2024 HairBear App. Todos os direitos reservados.
        </p>
      </footer>
    </div>
  );
